...
public class SimilarityAssessor
{
  ...
  public void printHit(String synsetId)
  {
      Hits synset = _broker.getHits ( IndexBroker.SYNSET + ":" + synsetId ) ;
        try {
            System.out.println("#"+synsetId+synset.doc(0).get(IndexBroker.WORDS));
            System.out.println(":"+synset.doc(0).get(IndexBroker.HYPERNYM));
            System.out.println("IC:"+synset.doc(0).get(IndexBroker.INFORMATION_CONTENT));
        } catch (IOException ex) {
            Logger.getLogger(SimilarityAssessor.class.getName()).log(Level.SEVERE, null, ex);
        }
  }
  ...
  /*  System.out.println(synset1.get(IndexBroker.WORDS)+":"+synset1.get ( IndexBroker.INFORMATION_CONTENT ));
    System.out.println("#"+synset1.get(IndexBroker.HYPERNYM));
    System.out.println(synset2.get(IndexBroker.WORDS)+":"+synset2.get ( IndexBroker.INFORMATION_CONTENT ));
